...
# 設定・定数定義
# ==============================
st.set_page_config(page_title="新高値ブレイク分析（堅牢化版）", layout="wide")
...
def get_canslim_details(stock):
    """
    CANSLIMの満たしている要素を文字列で返す。
    エラー防止のため safe_float を使用。
    """
    details = []
...
# UI
# ==============================
st.title("📈 新高値ブレイク分析 (Ver 28.1 - 修正済)")
st.caption("オニール流シグナル判定 / バグ修正完了版")
