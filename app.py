...
# 設定・定数定義 (閾値はここで管理)
# ==============================
st.set_page_config(page_title="新高値ブレイク分析（オニール流完全版）", layout="wide")
...
JP_NAME_MAP = {
    ...
    "5706": "三井金属", "5714": "DOWA", "5801": "古河電工", "5802": "住友電工",
    "5803": "フジクラ", "5831": "しずおかFG", "6098": "リクルート", "6103": "オークマ",
    "6113": "アマダ", "6146": "ディスコ", "6178": "日本郵政", "6273": "SMC",
    "6301": "コマツ", "6302": "住友重", "6305": "日立建機", "6326": "クボタ",
    "6337": "テセック", "6349": "小森コーポ", "6361": "荏原", "6367": "ダイキン",
    "6370": "栗田工業", "6471": "日本精工", "6472": "NTN", "6473": "ジェイテクト",
    "6479": "ミネベア", "6490": "日本ピラー", "6501": "日立", "6503": "三菱電機",
    "6504": "富士電機", "6506": "安川電機", "6526": "ソシオネクスト", "6532": "ベイカレント",
    "6645": "オムロン", "6674": "GSユアサ", "6701": "NEC", "6702": "富士通",
    "6723": "ルネサス", "6724": "エプソン", "6752": "パナソニック", "6753": "シャープ",
    "6758": "ソニーG", "6762": "TDK", "6770": "アルプスアル", "6787": "メイコー",
    "6841": "横河電機", "6857": "アドバンテスト", "6858": "小野測器", "6861": "キーエンス",
    "6902": "デンソー", "6920": "レーザーテク", "6952": "カシオ", "6954": "ファナック",
    "6963": "ローム", "6971": "京セラ", "6976": "太陽誘電", "6981": "村田製",
    "6988": "日東電工", "6998": "日本タングス", "7004": "カナデビア", "7011": "三菱重工",
    "7012": "川崎重工", "7013": "IHI", "7022": "サノヤスHD", "7186": "コンコルディア",
    "7201": "日産自", "7202": "いすゞ", "7203": "トヨタ", "7205": "日野自",
    "7211": "三菱自", "7261": "マツダ", "7267": "ホンダ", "7269": "スズキ",
    "7270": "SUBARU", "7272": "ヤマハ発", "7453": "良品計画", "7731": "ニコン",
    "7733": "オリンパス", "7735": "SCREEN", "7741": "HOYA", "7751": "キヤノン",
    "7752": "リコー", "7832": "バンナムHD", "7911": "TOPPAN", "7912": "大日印",
    "7951": "ヤマハ", "7974": "任天堂", "8001": "伊藤忠", "8002": "丸紅",
    "8015": "豊田通商", "8031": "三井物産", "8035": "東エレク", "8053": "住友商事",
    "8058": "三菱商事", "8233": "高島屋", "8252": "丸井G", "8253": "クレセゾン",
    "8267": "イオン", "8304": "あおぞら", "8306": "三菱UFJ", "8308": "りそなHD",
    "8309": "三井住友トラ", "8316": "三井住友FG", "8331": "千葉銀", "8354": "ふくおかFG",
    "8411": "みずほ", "8591": "オリックス", "8601": "大和証G", "8604": "野村HD",
    "8630": "SOMPO", "8697": "JPX", "8725": "MS&AD", "8750": "第一生命",
    "8766": "東京海上", "8795": "T&D", "8801": "三井不", "8802": "三菱地所",
    "8804": "東京建物", "8830": "住友不", "9001": "東武", "9005": "東急",
    "9007": "小田急", "9008": "京王", "9009": "京成", "9020": "JR東日本",
    "9021": "JR西日本", "9022": "JR東海", "9064": "ヤマトHD", "9101": "郵船",
    "9104": "商船三井", "9107": "川崎汽", "9147": "NXHD", "9201": "JAL",
    "9202": "ANA", "9432": "NTT", "9433": "KDDI", "9434": "ソフトバンク",
    "9501": "東電HD", "9502": "中部電", "9503": "関西電", "9504": "中国電",
    "9505": "北陸電", "9506": "東北電", "9507": "四国電", "9508": "九州電",
    "9509": "北海道電", "9511": "沖縄電", "9513": "電源開発", "9514": "エフオン",
    "9517": "イーレックス", "9519": "レノバ", "9531": "東ガス", "9532": "大ガス",
    "9602": "東宝", "9735": "セコム", "9766": "コナミG", "9843": "ニトリHD",
    "9983": "ファストリ", "9984": "ソフトバンクG", "9997": "ベルーナ"
}
...
def get_canslim_details(stock):
    details = []
    if stock.get("earnings_q_growth", 0) >= 0.20: details.append("C")
    te = stock.get("trailing_eps"); fe = stock.get("forward_eps")
    if te and fe and (fe - te) / abs(te) >= 0.15: details.append("A")
    if stock["broke_today"] or stock["broke_recent"]: details.append("N")
    if (stock["volume"] / stock["avg_volume"]) >= 1.5: details.append("S")
...
# UI
# ==============================
st.title("📈 新高値ブレイク分析 (Ver 28.0)")
st.caption("オニール流シグナル判定 / 日本語完全版")
